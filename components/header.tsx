...
export function Header() {
  ...
  return (
    <>
      <header className="st-glass sticky top-0 z-50 flex h-14 sm:h-16 items-center justify-between gap-4 border-b px-3 sm:px-5">
        <Link href="/" className="flex shrink-0 items-center gap-x-2 transition-opacity hover:opacity-90">
          <span className="relative flex items-center gap-1 text-xl font-extrabold tracking-tight sm:text-2xl">
            <span className="text-brand">SERVE</span>
            <span className="ml-0.5 rounded-sm bg-brand-hover px-1 py-0.5 text-brand-foreground">TUBE</span>
